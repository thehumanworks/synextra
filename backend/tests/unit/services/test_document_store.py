...
def test_build_page_texts_from_blocks_empty_page() -> None:
    ...
    blocks = [
        PdfTextBlock(page_number=1, block_no=0, bounding_box=[0, 0, 100, 20], text="Only on page 1"),
    ]
...
class TestDocumentStore:
    def _store_with_doc(self) -> DocumentStore:
        ...
        store.store_pages(
            ...
            filename="test.pdf",
            pages=[
                PageText(page_number=0, lines=["Line one.", "Line two.", "Line three."], line_count=3),
