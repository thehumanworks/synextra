...
from synextra_backend.services.rag_agent_orchestrator import RagAgentOrchestrator, _simple_summary
    ...
    citations = orchestrator._build_citations(
        [
            ...
            _chunk(
                chunk_id="c3",
                page_number=6,
                text="The Transformer uses multi-head attention in both encoder and decoder layers.",
            ),
        ]
    )
