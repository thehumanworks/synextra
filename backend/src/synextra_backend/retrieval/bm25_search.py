...
from synextra_backend.repositories.rag_document_repository import ChunkRecord
...
class Bm25IndexStore:
    ...
    def search(self, *, query: str, top_k: int = 6, document_ids: list[str] | None = None) -> list[EvidenceChunk]:
        with self._lock:
