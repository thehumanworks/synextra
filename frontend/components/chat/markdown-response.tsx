...
import { normalizeLatexDelimiters } from "@/lib/chat/latex-delimiters";
...
export const MarkdownResponse = memo(
  ({
    ...
    const mergedComponents = useMemo(() => {
      if (!citationReferenceScopeId || !onCitationReferenceClick) {
        return components;
      }
      ...
      return {
        ...
        a: ({
          ...
          const index = parseCitationReferenceHref(
            href,
            citationReferenceScopeId,
          );
          if (index != null) {
