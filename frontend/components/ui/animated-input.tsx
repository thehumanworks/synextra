...
export function AnimatedInput({
  ...
  return (
    <div
      data-testid="animated-input-container"
    ...
    >
      ...
      <div className="flex-1">
        <input
          ...
          className="w-full border-none bg-transparent text-sm font-light leading-relaxed text-stone-100 placeholder-stone-400 outline-none"
        />
      </div>
    </div>
  )
